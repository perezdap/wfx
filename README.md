...
- API keys are not printed and are redacted if an endpoint echoes one in an error. Approval prompts and tool-call summaries show truncated arguments and replace known provider secrets with `[REDACTED]`.
