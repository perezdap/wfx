...
/// approval gate and the human-output split (ADR 0008) above all — are decidable in-process
...
public interface IConsoleEnvironment
{
    ...
    /// <summary>Standard output is redirected, so it should carry the final response (ADR 0008).</summary>
